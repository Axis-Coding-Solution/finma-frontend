...
import { CornerDownRight, Star, StarHalf } from "lucide-react";
    ...
    <div className="bg-[#F8F8F8] p-4 ">
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between">
          <h4 className="text-sm text-secondary-foreground">Shared media</h4>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between">
          <h4 className="text-sm text-secondary-foreground">Shared files</h4>
          <Link to="/" className="text-sm underline font-medium">
            View all
          </Link>
        </div>
        <div className="flex flex-col gap-4 mt-4">
          <div className="flex items-center justify-between gap-2">
            ...
            <span className="text-secondary-foreground text-sm">129,2 KB</span>
          </div>
          <div className="flex items-center justify-between gap-2">
            <div className="flex  gap-2">
              <img src={sharedFile} className="w-10" alt="" />
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between">
          <h4 className="text-sm text-secondary-foreground">Shared links</h4>
          <Link to="/" className="text-sm underline font-medium">
            View all
          </Link>
        </div>
