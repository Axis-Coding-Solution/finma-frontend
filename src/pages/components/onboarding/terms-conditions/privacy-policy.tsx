      ...
      <div className="flex flex-col 2xl:gap-4 gap-2 2xl:px-5 px-4 2xl:py-8 py-4">
          ...
          <p>
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <h1>
                ...
                you provide when you use our Services, such as comments,
                feedback, and other content you submit.
              </h1>
              <h1>
                <span className="font-bold">d) Technical Data:</span>{" "}
                Information collected through cookies, web beacons, and other
                tracking technologies, such as device information, browser type,
        ...
        <div>
          ...
          <p>
            ...
            data and improve the functionality and performance of the Services.
