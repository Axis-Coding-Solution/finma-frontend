    ...
    <div className=" flex flex-col 2xl:gap-4 gap-2 2xl:px-5 px-4 2xl:py-8 py-4">
      ...
      <div>
        ...
        <span>
          ...
          <ul className="list-disc ml-5">
            ...
            <li>
              Use the Services to store or transmit any material that is harmful
              or prohibited by these Service Terms.
            </li>
      ...
      <div>
        ...
        <p>
          ...
          required by law. We reserve the right to change the subscription fees
      ...
      <div>
        ...
        <p>
          ...
          or materials provided through the Services without our prior written
          consent.
        </p>
      </div>
      <div>
        ...
        <p>
          ...
          distribute your content in connection with the Services. You represent
          and warrant that you have the rights to any content you submit and
          that your content does not violate any third-party rights or
          applicable laws.
        </p>
      </div>
      <div>
        ...
        <p>
          ...
          is incorporated by reference into these Service Terms. Please review
      ...
      <div>
        ...
        <p>
          ...
          personal information stored therein; (c) any bugs, viruses, trojan
          horses, or the like that may be transmitted to or through our Services
          by any third party; or (d) any errors or omissions in any content or
      ...
      <div>
        ...
        <p>
          ...
          with the French Law, without regard to its conflict of law principles.
          Any disputes arising out of or relating to these Service Terms or the
          Services shall be resolved exclusively in the courts of the City of
          Paris.
        </p>
      </div>
      <div>
