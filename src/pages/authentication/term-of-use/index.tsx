    ...
    <div className="container bg-white rounded-xl p-5">
      ...
      <ScrollArea className="h-[350px]">
          <div className="md:mx-10 my-5 ">
            ...
            <p>
              Welcome to FinmaAI! By signing up for our platform, you agree to
              the following terms and conditions (the "Service Terms"). These
              Service Terms govern your use of FinmaAI's services, including our
              website, AI evaluation tool, community forum, and any related
            ...
            <p>
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <h1>
                  ...
                  about how you interact with the Services, such as your IP
                  address, browser type, pages visited, and the time and date of
                  your visits
                </h1>
                <h1>
                  <span className="font-bold">c) Content Data:</span>{" "}
                  Information you provide when you use our Services, such as
                  comments, feedback, and other content you submit.
                </h1>
                <h1>
                  <span className="font-bold">d) Technical Data:</span>{" "}
                  Information collected through cookies, web beacons, and other
                  tracking technologies, such as device information, browser
          ...
          <div className="md:mx-10 my-5 ">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <h1>
                ...
                We use your personal information to deliver the Services,
                process your transactions, and improve the overall user
                experience.
              </h1>
              <h1>
                <span className="font-bold">b) To Communicate with You:</span>{" "}
                We use your contact information to send you updates,
              ...
              <h1>
                ...
                We use usage data to analyze how users interact with the
                Services, identify trends, and improve the functionality and
              ...
              <h1>
                ...
                Services, detect and prevent fraudulent activities, and comply
          ...
          <div className="md:mx-10 my-5 ">
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <h1>
                <span className="font-bold">c) Business Transfers: </span> In
          ...
          <div className="md:mx-10 my-5 ">
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <h1>
                <span className="font-bold">b) Opt-Out:</span> You can opt out
              ...
              <h1>
                ...
                request the deletion of your personal information by contacting
                us at [Your Contact Information]. Please note that we may retain
          ...
          <div className="md:mx-10 my-5 ">
            ...
            <p>
              ...
              data and improve the functionality and performance of the
          ...
          <div className="md:mx-10 my-5 ">
            ...
            <p>
              ...
              warranties of any kind, either express or implied. FinmaAI does
              not warrant that the Services will be uninterrupted or error-free,
              and FinmaAI disclaims all warranties, express or implied,
