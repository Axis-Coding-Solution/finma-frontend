    ...
    <>
      <div className="bg-muted rounded-lg p-6 flex flex-col gap-4">
        <div className="relative">
          ...
          />
          <img className="md:w-32 w-20 sm:block hidden absolute md:top-0 top-2 md:left-60 left-52" src={ArrowLong} />
        </div>
        <MainHeading
      ...
      {/* Accordion Section  */}
      <div>
        <Accordion type="single" defaultValue="item-1" className="transition flex flex-col gap-3">
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>What kind of support does FinmaAI provide?</AccordionTrigger>
            <AccordionContent>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
            </AccordionContent>
          </AccordionItem>
